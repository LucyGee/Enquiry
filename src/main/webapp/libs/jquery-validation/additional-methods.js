...
$.validator.addMethod("mobileNumber", function(value, element) {
	return this.optional(element) || /^((\+|00)[0-9]{1,3}[\s]{0,1}[\-]{0,1}){0,1}([0-9]{0,3})([\s]{0,1}[\-]{0,1}[\s]{0,1}[0-9]{6,10})$/i.test(value);
}, "Please specify a valid mobile number 'country code (optional)-area code(optional)-number'");
/*
