  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <p class="masthead-subheading font-weight-light mb-0"> 
        Get the opportunity to Ascertain and Verify that qualifications presented by the employee you wish to hire or the student
        you will admit to your institution are true and credible.<br>
        <b>Check - Verify - Be Sure!</b><br>
        <a href="login">To Get Started</a></p>
    </div>
  </header>
